init:
	gcc -o fput_encrypt.o fput_encrypt.c -lcrypto
	sudo chown root fput_encrypt.o
	sudo chgrp root fput_encrypt.o
	sudo chmod u+s fput_encrypt.o
	gcc -o fget_decrypt.o fget_decrypt.c -lcrypto
